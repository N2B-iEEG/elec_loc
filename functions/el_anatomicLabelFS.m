function [aLabel,labels,indArea]=el_anatomicLabelFS(pos, atlasFile,LUTfile,lookAround,atlasMatrix,atlasS,labels,values,opt)

% Modified from anatomicLabelFS function of iElectrodes
% See below for original release notes
...
if lookAround==0 % atlas from exact pos
    for i=1:N
        try
            ...
            val=0; % If out of range, assign unknown
        end
